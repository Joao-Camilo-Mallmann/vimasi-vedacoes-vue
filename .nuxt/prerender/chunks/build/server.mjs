...
import { getContext, executeAsync } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/joao/projects/vimasi-vedacoes-vue2/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DTjaDFsr.mjs')
  },
  {
    name: "contato",
    path: "/contato",
    component: () => import('./contato-xU8RbD7Z.mjs')
  },
  {
    name: "gaxetas",
    path: "/gaxetas",
    component: () => import('./gaxetas-BaMPpsf-.mjs')
  },
  {
    name: "vedacoes",
    path: "/vedacoes",
    component: () => import('./vedacoes-DCJTceV6.mjs')
  },
  {
    name: "aneis-vedacao",
    path: "/aneis-vedacao",
    component: () => import('./aneis-vedacao-DMY1pwzc.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BR9J9rmn.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BvOLFdG6.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CW_7aLIq.mjs'));
